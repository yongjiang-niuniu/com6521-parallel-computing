 ...
 */
uint64_t cpu_countGliders(const unsigned char *cells, size_t width, size_t height);
/**
 ...
 */
size_t cpu_histogram(const int *numbers, size_t length, int bin_width, int *output);
/**
 ...
 */
void cpu_emboss(const unsigned char * pixels, unsigned int width, unsigned int height, unsigned char *output);
